...
const classToAirQuality = {
  "Good": {
    ...
    explanation: "AI ตรวจพบลักษณะไลเคนที่อยู่ในกลุ่ม Good จากข้อมูลที่ใช้ฝึกโมเดล จึงประเมินคุณภาพอากาศในระดับดี"
  },

  "Moderate": {
    quality: "🟡 คุณภาพอากาศปานกลาง",
    explanation: "AI ตรวจพบลักษณะไลเคนที่อยู่ในกลุ่ม Moderate จากข้อมูลที่ใช้ฝึกโมเดล จึงประเมินคุณภาพอากาศในระดับปานกลาง"
  },

  "Poor": {
    quality: "🔴 คุณภาพอากาศไม่ดี",
    explanation: "AI ตรวจพบลักษณะไลเคนที่อยู่ในกลุ่ม Poor จากข้อมูลที่ใช้ฝึกโมเดล จึงประเมินคุณภาพอากาศในระดับไม่ดี"
  },

  "No Lichen": {
    quality: "⚪ ไม่พบไลเคน",
    explanation: "AI ไม่พบลักษณะของไลเคนที่ชัดเจน กรุณาถ่ายภาพใหม่โดยให้ไลเคนอยู่ตรงกลางภาพและมีแสงเพียงพอ"
  }
};
